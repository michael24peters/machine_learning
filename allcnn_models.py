...
## NOTE: This is a compilation of multiple allcnn model files put into one. This
## file is broken up into sections by the date these models were first implemented
## under. For example, there is a section from 15 July, 2020. A good place to start
## if you want to find a particular model is to Ctrl+F or Cmd+F search by year (e.g.
## 2020 or 2021).
...
## convolutional layer.
## The hope is that the learning from the (X) feature can start from
...
'''
These models are from the 15 July, 2020.
'''
...
'''
These models are from 26 December, 2020
'''
...
'''
These models are from 30 January, 2021
'''
...
class ACN_4i4_P_6L_C(nn.Module):
    def __init__(self):
        super(ACN_4i4_P_6L_C, self).__init__()
        ##
        ##  we will re-use the names of the convolutional layers from All_CNN6Layer_A
        ##  for the (X) feature set; then use similar (but different) names for
        ##  the layers that process the "pertubative" features (x,y)
...
5. SimpleCNN5Layer, TwoFeature_CNN6Layer_A, and All_CNN6Layer_A are intermediate models to obtain well-trained models to use for the perturbative model.
'''
class ACN_1i4_6L_RC1(nn.Module):
    softplus = torch.nn.Softplus()
    def __init__(self):
...
class ACN_2i4_6L_RC1(nn.Module):
    '''
    This is used to pretrain the X feature set
    '''
    def __init__(self):
        super(ACN_2i4_6L_RC1, self).__init__()
...
class ACN_3i4_6L_RC1(nn.Module):
    '''
    This is used to pretrain the (x,y) feature set
    '''
    def __init__(self):
        super(ACN_3i4_6L_RC1, self).__init__()
...
class ACN_4i4_P_6L_RC1_C(nn.Module):
    ## This is the perturbative model
    def __init__(self):
        super(ACN_4i4_P_6L_RC1_C, self).__init__()
        self.conv1 = nn.Conv1d(
            in_channels=1,
            out_channels=16,
            kernel_size=25,
...
## In order for this model to work, try an 8 layer, skip connection SimpleCNN 
## model as foundation
class ACN_1i4_8L_3S(nn.Module):
    def __init__(self):
        super(ACN_1i4_8L_3S, self).__init__()
...
class ACN_2i4_8L_3S(nn.Module):
    '''
    This is used to pretrain the X feature set
    '''
    def __init__(self):
        super(ACN_2i4_8L_3S, self).__init__()
...
class ACN_3i4_P_8L_3S(nn.Module):
    '''
    This is used to pretrain the (x,y) feature set
    '''
    def __init__(self):
        super(ACN_3i4_P_8L_3S, self).__init__()
...
class ACN_4i4_P_8L_3S(nn.Module):
    def __init__(self):
        super(ACN_4i4_P_8L_3S, self).__init__()
